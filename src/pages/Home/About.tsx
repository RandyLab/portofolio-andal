  ...
  return (
    <section id="about" className="min-h-screen w-full py-20 text-gray-900">
      <div className="mx-auto max-w-6xl px-6 space-y-16">
        ...
        {/* Profile Card */}
        <motion.div
          className="flex flex-col md:flex-row items-center gap-12 rounded-xl border border-gray-200 shadow-lg p-10 bg-white"
          initial="hidden"
          whileInView="visible"
        ...
        >
          <motion.img
            ...
            className="w-40 md:w-56 rounded-md border-4 border-indigo-950/80 shadow-[4px_4px_50px_rgba(86,36,255,0.2)]"
            variants={fadeInUp}
          />
          ...
          >
            ...
            <h3 className="text-3xl font-bold">{`Randy Andal Bangun`}</h3>
        ...
        >
          ...
          <motion.div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 md:order-1 order-2" variants={fadeInUp}>
          ...
          >
            ...
            />
            <div className="space-y-4">
              <h4 className="text-2xl font-semibold">Engineering Principles</h4>
