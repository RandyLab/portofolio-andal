			...
			<div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
				...
				<div className="space-y-6 text-center md:text-left order-2 md:order-1">
					...
					<div className="flex justify-center md:justify-start gap-4 pt-4">
						...
						<a href="/contact" className="px-6 py-3 rounded-xl border border-gray-300 text-gray-700 hover:bg-gray-100 transition">
							Contact Me
						</a>
					</div>
				</div>
				...
				<div className="relative flex items-center justify-center order-1 md:order-2">
					<div ref={triggerRef}>
						<img
							src={randy}
							alt="React Icon"
							className={`w-auto h-96 md:h-128 animate-spin-slow relative fade-animation ${
								visible ? "is-visible" : ""
							}`}
						/>
					</div>
