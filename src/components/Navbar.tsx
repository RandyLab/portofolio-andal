...
export default function Navbar() {
  ...
  return (
    <nav className="fixed bg-gray-900 text-white px-4 py-3 flex justify-center items-center w-screen shadow-lg shadow-gray-950/45 z-40">
      <div className="w-full max-w-4xl flex justify-between items-center">
        ...
        >
          <img src={isOpen ? IconClose : IconMenu} alt="menu toggle" />
        </button>
      </div>
  ...
  `}
      ...
      >
        <div
          className={`
      absolute shadow-[-8px_0_20px_rgba(0,0,0,0.45)] right-0 top-0 h-full w-2/3 bg-gray-900 p-6
